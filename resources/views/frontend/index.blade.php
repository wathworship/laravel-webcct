    ...
    <div class="container pt-4 mt-2">
        <div class="media-container-row">
            ...
            <div class="card  col-12 col-md-6 col-lg-3">
                <div class="card-img">
                        <a href="news-public-relations.html"><span class="mbr-iconfont mbri-flag" style="color: rgb(47, 0, 47); fill: rgb(47, 0, 47);"></span></a>
                </div>
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-5">
                        ข่าวประชาสัมพันธ์</h4>
                    
                    <div class="mbr-section-btn text-center"><a href="news-public-relations.html" class="btn btn-secondary btn-sm"><span class="text-white display-4">อ่านเพิ่มเติม. . .</span></a></div>
                </div>
            </div>

            <div class="card  col-12 col-md-6 col-lg-3">
                <div class="card-img">
                        <a href="news-units.html"><span class="mbr-iconfont mbri-image-gallery" style="color: rgb(47, 0, 47); fill: rgb(47, 0, 47);"></span></a>
                </div>
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-5">
                        ข่าวหน่วยงาน</h4>
                    
                    <div class="mbr-section-btn text-center"><a href="news-units.html" class="btn btn-secondary btn-sm"><span class="text-white display-4">อ่านเพิ่มเติม. . .</span></a></div>
                </div>
            </div>

            <div class="card  col-12 col-md-6 col-lg-3">
                <div class="card-img">
                    <span class="mbr-iconfont mbri-file" style="color: rgb(47, 0, 47); fill: rgb(47, 0, 47);"></span>
                </div>
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-5">ข่าวประกวดราคา</h4>
                    
                    <div class="mbr-section-btn text-center"><a href="news-tender.html" class="btn btn-secondary btn-sm"><span class="text-white display-4">อ่านเพิ่มเติม. . .</span></a></div>
                </div>
            </div>

            <div class="card  col-12 col-md-6 col-lg-3">
                <div class="card-img">
                    <span class="mbr-iconfont mbri-calendar" style="color: rgb(47, 0, 47); fill: rgb(47, 0, 47);"></span>
                </div>
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-5">
                        ข่าวรับสมัครงาน</h4>
                    
                    <div class="mbr-section-btn text-center"><a href="news-apply-jobs.html" class="btn btn-secondary btn-sm"><span class="text-white display-4">อ่านเพิ่มเติม. . .</span></a></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container pt-4 mt-2">
            <div class="media-container-row">
                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        <div class="card-img pb-3">
                            <a href="journals-church.html"><span class="mbr-iconfont mbri-windows" style="color: rgb(71, 65, 58); fill: rgb(71, 65, 58);"></span></a>
                        </div>
                    ...
                    <a href="journals-church.html"><span class="d-block p-2 bg-primary text-white display-4">รายละเอียด . . .</span></a>
                </div>
                ...
                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        <div class="card-img pb-3">
                            <a href="journals-upper-room.html"><span class="mbr-iconfont mbri-help" style="color: rgb(71, 65, 58); fill: rgb(71, 65, 58);"></span></a>
                        </div>
                        <div class="card-text">
                            <h3 class="pt-3 pb-3 mbr-fonts-style display-5">
                                  ห้องชั้นบน</h3> 
                    ...
                    <a href="journals-up.html"><span class="d-block p-2 bg-primary text-white display-4">รายละเอียด . . .</span></a>
                </div>

                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        <div class="card-img pb-3">
                            <a href="journals-relationship.html"><span class="mbr-iconfont mbri-users" style="color: rgb(71, 65, 58); fill: rgb(71, 65, 58);"></span></a>
                        </div>
                        <div class="card-text">
                            <h3 class="pt-3 pb-3 mbr-fonts-style display-5">
                                  สานสัมพันธ์</h3>
                    ...
                    <a href="journals-relationship.html"><span class="d-block p-2 bg-primary text-white display-4">รายละเอียด . . .</span></a>
                </div>
                ...
                <div class="card p-3 align-center col-12 col-md-6 col-lg-3">
                    <div class="panel-item p-3">
                        <div class="card-img pb-3">
                            <a href="journals-others.html"><span class="mbr-iconfont mbri-pages" style="color: rgb(79, 73, 67); fill: rgb(79, 73, 67);"></span></a>
                        </div>
                    ...
                    <a href="journals-others.html"><span class="d-block p-2 bg-primary text-white display-4">รายละเอียด . . .</span></a>
                </div>
            </div>
        </div>
   </div>
