...
@section('content')
<section class="mbr-section content4 cid-rc2BKlGY1Z" id="content4-2f">
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2"><strong>ข่าวประกวดราคา</strong></h2>
                <h4 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-7">
...
<section class="mbr-section article content11 cid-rc2BQdlEiX" id="content11-2g">
    <div class="container">        
        <div class="media-container-row">           
