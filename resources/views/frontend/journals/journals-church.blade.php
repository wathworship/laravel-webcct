        ...
        <div class="media-container-row title">
            <div class="col-12 col-md-8">
                <div class="mbr-section-btn align-center">
                    <a class="btn btn-secondary display-4" href="{{url('journalch')}}">ข่าวคริสตจักร</a>
                    <a class="btn btn-secondary-outline display-4" href="{{url('journalup')}}">ห้องชั้นบน</a> 
                    <a class="btn btn-secondary-outline display-4" href="{{url('journalre')}}">สานสัมพันธ์</a> 
                    ...
                    <div class="card-wrapper align-center">
                        <div class="card-img">
                            ...
                            <div class="mbr-section-btn text-center">
                                <a target="_blank" href="pdf/journal/jn-ch/{{$journal->journals_file}}" class="btn btn-info display-4">
                                    <span class="mbri-download mbr-iconfont mbr-iconfont-btn"></span>ดาวน์โหลด
                                </a>
                            </div>
